...
async function RightSidebarAdmin({ user }: AdminSidebarProps) {
    ...
    <aside className="right-sidebar">
      ...
      <section className="banks">
        <div className="flex w-full justify-between">
          ...
          <Link href="/a-projects/create" className="flex gap-2">
            <Image 
              src="/icons/plus.svg"
              width={20}
              height={20}
...
export default RightSidebarAdmin;